...
def getFollowers(user):
    ...
    bot.write_list_to_file_v2(user, followers_list, "followers")
    bot.close_driver()
...
def getFollowing(user):
    ...
    bot.write_list_to_file_v2(user, following_list, "following")
    bot.close_driver()
...
def getUnfollowers(user):
    ...
    bot.write_list_to_file_v2(user, followers, "followers")

    following = bot.get_following_list_v2(user)
    bot.write_list_to_file_v2(user, following, "following")

    unfollowers = bot.get_unfollowers_list(followers, following)
    bot.write_list_to_file_v2(user, unfollowers, "unfollowers")
